 ...
 * @export
 * @interface ProductUpdateProductDetailsRequestManufacturerWarranty
 */
export interface ProductUpdateProductDetailsRequestManufacturerWarranty {
    /**
     * A URL linking to the full details of the manufacturer\'s warranty, probably on the manufacturer\'s website.
     * @type {string}
     * @memberof ProductUpdateProductDetailsRequestManufacturerWarranty
     */
    'url'?: string;
    /**
